...
console.log(chalk.greenBright('ARTDRIAN AI ACTIVE'));
...
async function startAlyaBot() {
	...
	const getMessage = async (key) => {
		...
		return {
			conversation: 'Halo Saya Artdrian'
		}
	}
	...
	if (pairingCode && !phoneNumber && !alya.authState.creds.registered) {
		async function getPhoneNumber() {
			phoneNumber = global.number_bot ? global.number_bot : process.env.BOT_NUMBER || await question('Artdrian Active🟢👐….....\nBot Name : Artdrian\nOwner : +6283879458878\nName Owner : Pratama\n\nMasukan Nomor Bot WhatsApp Anda🤖💤 : ');
